    ...
    <div className="space-y-4">
      ...
      <div className="bg-card border border-border rounded-xl p-3 md:p-4 space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          <label className="text-sm text-muted-foreground shrink-0">Deposit:</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-32 sm:w-36 bg-muted border-0 rounded-lg pl-7 pr-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
              min={0}
              step={100}
            />
          </div>
          <div className="ml-0 sm:ml-auto text-xs sm:text-sm text-muted-foreground w-full sm:w-auto">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs bg-muted text-muted-foreground hover:text-foreground rounded-lg transition-colors whitespace-nowrap"
          >
          ...
          <button
            onClick={onRefresh}
            disabled={refreshing}
            className="px-3 py-1.5 text-xs bg-primary/20 text-primary hover:bg-primary/30 rounded-lg transition-colors disabled:opacity-50 whitespace-nowrap"
          >
            {refreshing ? (
          ...
          <select
            ...
            className="px-2 py-1.5 text-xs bg-muted rounded-lg border-0 text-muted-foreground min-w-[76px]"
          >
          ...
          {autoRefreshSec > 0 && (
            <span className="flex items-center gap-1 px-2 py-1 rounded-full bg-green-500/15 text-green-400 text-xs whitespace-nowrap">
