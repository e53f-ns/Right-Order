      ...
      <div className="glass-card rounded-xl p-3 md:p-4 space-y-3">
        ...
        <div className="w-full flex flex-wrap items-center gap-2 min-w-0">
          <input type="text" value={symbolFilter} placeholder="Filter symbol..."
            onChange={e => setSymbolFilter(e.target.value)} className="input-field text-xs w-full sm:w-36" />
          <select value={regimeFilter} onChange={e => setRegimeFilter(e.target.value)}
            className="input-field text-[11px] py-1.5 w-full sm:w-auto sm:min-w-[130px]">
