    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <motion.div variants={itemVariants} className="glass-card rounded-xl p-4">
          ...
          <div className="space-y-1">
            {topSpreads.map((s, i) => (
              <div key={i} className="flex items-center justify-between gap-3 p-2.5 rounded-lg bg-white/[0.02]">
                ...
                <span className={`text-xs font-bold shrink-0 ${s.net > 0 ? 'text-green-400' : 'text-red-400'}`} style={{ fontFamily: 'var(--font-heading)' }}>
