  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className={`main-content ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
        ...
        <footer className="border-t border-border px-4 md:px-6 py-3 flex items-center justify-between text-[11px] text-muted-foreground">
      ...
      <div className="ml-auto flex items-center gap-2 md:gap-3">
        ...
        {authUser && (
          <div className="flex items-center gap-1.5">
            <span className="text-xs text-muted-foreground hide-tablet">{authUser.email}</span>
            {authUser.role === 'admin' && (
